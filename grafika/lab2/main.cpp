...
{
        //Dzien Dobry, zakladam ze sprawdza Pan ten program majac gorszy dzien, pisalem te funkcje bardzo zmeczony wiec albo moze Pan
    //poprawic sobie humor i zasmiac z mojej gluoty i ponizszego kodu, lub z tego samego powodu dzien sobie bardziej pogorszyc
    //W kazdym razie przepraszam za przedstawiony ponizej kod. Pozdrawiam serdecznie, Bartosz Konopka
    ...
    sqr11[2].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,0.75-0.75*slid_position));
    sqr11[3].position=sf::Vector2f(center.x,center.y);
    sqr11[3].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0.75-0.75*slid_position));
    ...
    sqr12[0].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,0));
    sqr12[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*2);
    sqr12[1].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,0));
    sqr12[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*2);
    sqr12[2].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,0.75-0.75*slid_position));
    sqr12[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6);
    sqr12[3].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,0.75-0.75*slid_position));
    sqr12[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6);
    sqr12[4].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,0));

    sf::VertexArray sqr13(sf::Quads, 5);
    sqr13[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*2);
    sqr13[0].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,0));
    sqr13[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*3);
    sqr13[1].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,0));
    sqr13[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*3);
    sqr13[2].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,0.75-0.75*slid_position));
    sqr13[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*2);
    sqr13[3].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,0.75-0.75*slid_position));
    sqr13[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*2);
    sqr13[4].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,0));

    sf::VertexArray sqr14(sf::Quads, 5);
    sqr14[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*3);
    sqr14[0].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,0));
    sqr14[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*4);
    sqr14[1].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,0));
    sqr14[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*4);
    sqr14[2].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,0.75-0.75*slid_position));
    sqr14[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*3);
    sqr14[3].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,0.75-0.75*slid_position));
    sqr14[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*3);
    sqr14[4].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,0));

    sf::VertexArray sqr15(sf::Quads, 5);
    sqr15[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*4);
    sqr15[0].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,0));
    sqr15[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*5);
    sqr15[1].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,0));
    sqr15[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*5);
    sqr15[2].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,0.75-0.75*slid_position));
    sqr15[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*4);
    sqr15[3].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,0.75-0.75*slid_position));
    sqr15[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*4);
    sqr15[4].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,0));

    sf::VertexArray sqr16(sf::Quads, 5);
    sqr16[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*5);
    sqr16[0].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,0));
    sqr16[1].position=sf::Vector2f(p[1].x,p[1].y+p[2].y-p[1].y);
    sqr16[1].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0));
    sqr16[2].position=sf::Vector2f(center.x,center.y+p[2].y-p[1].y);
    sqr16[2].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0.75-0.75*slid_position));
    sqr16[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*5);
    sqr16[3].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,0.75-0.75*slid_position));
    sqr16[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*5);
    sqr16[4].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,0));

    sf::VertexArray sqr21(sf::Quads, 5);
    sqr21[0].position=sf::Vector2f(p[5].x,p[5].y);
    sqr21[0].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr21[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6);
    sqr21[1].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr21[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6);
    sqr21[2].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr21[3].position=sf::Vector2f(center.x,center.y);
    sqr21[3].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr21[4].position=sf::Vector2f(p[5].x,p[5].y);
    sqr21[4].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,1-1*slid_position));

    sf::VertexArray sqr22(sf::Quads, 5);
    sqr22[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6);
    sqr22[0].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr22[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*2);
    sqr22[1].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr22[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*2);
    sqr22[2].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr22[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6);
    sqr22[3].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr22[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6);
    sqr22[4].color=sf::Color(HSL_RGB(RGB_hue(255,0,255),1,1-1*slid_position));

    sf::VertexArray sqr23(sf::Quads, 5);
    sqr23[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*2);
    sqr23[0].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr23[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*3);
    sqr23[1].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr23[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*3);
    sqr23[2].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr23[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*2);
    sqr23[3].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr23[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*2);
    sqr23[4].color=sf::Color(HSL_RGB(RGB_hue(0,0,255),1,1-1*slid_position));

    sf::VertexArray sqr24(sf::Quads, 5);
    sqr24[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*3);
    sqr24[0].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr24[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*4);
    sqr24[1].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr24[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*4);
    sqr24[2].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr24[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*3);
    sqr24[3].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr24[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*3);
    sqr24[4].color=sf::Color(HSL_RGB(RGB_hue(0,255,255),1,1-1*slid_position));

    sf::VertexArray sqr25(sf::Quads, 5);
    sqr25[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*4);
    sqr25[0].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr25[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*5);
    sqr25[1].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr25[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*5);
    sqr25[2].color=sf::Color(HSL_RGB(RGB_hue(225,255,0),1,1-1*slid_position));
    sqr25[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*4);
    sqr25[3].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr25[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*4);
    sqr25[4].color=sf::Color(HSL_RGB(RGB_hue(0,255,0),1,1-1*slid_position));

    sf::VertexArray sqr26(sf::Quads, 5);
    sqr26[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*5);
    sqr26[0].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr26[1].position=sf::Vector2f(p[5].x,p[5].y+p[4].y-p[5].y);
    sqr26[1].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr26[2].position=sf::Vector2f(center.x,center.y+p[4].y-p[5].y);
    sqr26[2].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr26[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*5);
    sqr26[3].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr26[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*5);
    sqr26[4].color=sf::Color(HSL_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    ...
    rhombus1[0].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0.1));
    rhombus1[1].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0));
    rhombus1[2].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0.75-0.75*slid_position));
    rhombus1[3].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0.75-0.75*slid_position));
    rhombus1[4].color=sf::Color(HSL_RGB(RGB_hue(255,0,0),1,0.1));
    target.draw(rhombus1, states);
...
void hexagon_HSB::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
    ...
    sf::VertexArray sqr11(sf::Quads, 5);
    sqr11[0].position=sf::Vector2f(p[1].x,p[1].y);
    sqr11[0].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,0));
    sqr11[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6);
    sqr11[1].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,0));
    sqr11[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6);
    sqr11[2].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr11[3].position=sf::Vector2f(center.x,center.y);
    sqr11[3].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr11[4].position=sf::Vector2f(p[1].x,p[1].y);
    sqr11[4].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,0));

    sf::VertexArray sqr12(sf::Quads, 5);
    sqr12[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6);
    sqr12[0].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,0));
    sqr12[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*2);
    sqr12[1].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,0));
    sqr12[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*2);
    sqr12[2].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr12[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6);
    sqr12[3].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr12[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6);
    sqr12[4].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,0));

    sf::VertexArray sqr13(sf::Quads, 5);
    sqr13[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*2);
    sqr13[0].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,0));
    sqr13[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*3);
    sqr13[1].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,0));
    sqr13[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*3);
    sqr13[2].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr13[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*2);
    sqr13[3].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr13[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*2);
    sqr13[4].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,0));

    sf::VertexArray sqr14(sf::Quads, 5);
    sqr14[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*3);
    sqr14[0].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,0));
    sqr14[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*4);
    sqr14[1].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,0));
    sqr14[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*4);
    sqr14[2].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr14[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*3);
    sqr14[3].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr14[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*3);
    sqr14[4].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,0));

    sf::VertexArray sqr15(sf::Quads, 5);
    sqr15[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*4);
    sqr15[0].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,0));
    sqr15[1].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*5);
    sqr15[1].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,0));
    sqr15[2].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*5);
    sqr15[2].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr15[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*4);
    sqr15[3].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr15[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*4);
    sqr15[4].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,0));

    sf::VertexArray sqr16(sf::Quads, 5);
    sqr16[0].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*5);
    sqr16[0].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,0));
    sqr16[1].position=sf::Vector2f(p[1].x,p[1].y+p[2].y-p[1].y);
    sqr16[1].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,0));
    sqr16[2].position=sf::Vector2f(center.x,center.y+p[2].y-p[1].y);
    sqr16[2].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr16[3].position=sf::Vector2f(center.x,center.y+(p[2].y-p[1].y)/6*5);
    sqr16[3].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr16[4].position=sf::Vector2f(p[1].x,p[1].y+(p[2].y-p[1].y)/6*5);
    sqr16[4].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,0));

    sf::VertexArray sqr21(sf::Quads, 5);
    sqr21[0].position=sf::Vector2f(p[5].x,p[5].y);
    sqr21[0].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr21[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6);
    sqr21[1].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr21[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6);
    sqr21[2].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr21[3].position=sf::Vector2f(center.x,center.y);
    sqr21[3].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr21[4].position=sf::Vector2f(p[5].x,p[5].y);
    sqr21[4].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));

    sf::VertexArray sqr22(sf::Quads, 5);
    sqr22[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6);
    sqr22[0].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr22[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*2);
    sqr22[1].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr22[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*2);
    sqr22[2].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr22[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6);
    sqr22[3].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));
    sqr22[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6);
    sqr22[4].color=sf::Color(HSB_RGB(RGB_hue(255,0,255),1,1-1*slid_position));

    sf::VertexArray sqr23(sf::Quads, 5);
    sqr23[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*2);
    sqr23[0].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr23[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*3);
    sqr23[1].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr23[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*3);
    sqr23[2].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr23[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*2);
    sqr23[3].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));
    sqr23[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*2);
    sqr23[4].color=sf::Color(HSB_RGB(RGB_hue(0,0,255),1,1-1*slid_position));

    sf::VertexArray sqr24(sf::Quads, 5);
    sqr24[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*3);
    sqr24[0].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr24[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*4);
    sqr24[1].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr24[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*4);
    sqr24[2].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr24[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*3);
    sqr24[3].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));
    sqr24[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*3);
    sqr24[4].color=sf::Color(HSB_RGB(RGB_hue(0,255,255),1,1-1*slid_position));

    sf::VertexArray sqr25(sf::Quads, 5);
    sqr25[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*4);
    sqr25[0].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr25[1].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*5);
    sqr25[1].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr25[2].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*5);
    sqr25[2].color=sf::Color(HSB_RGB(RGB_hue(225,255,0),1,1-1*slid_position));
    sqr25[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*4);
    sqr25[3].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));
    sqr25[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*4);
    sqr25[4].color=sf::Color(HSB_RGB(RGB_hue(0,255,0),1,1-1*slid_position));

    sf::VertexArray sqr26(sf::Quads, 5);
    sqr26[0].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*5);
    sqr26[0].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr26[1].position=sf::Vector2f(p[5].x,p[5].y+p[4].y-p[5].y);
    sqr26[1].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr26[2].position=sf::Vector2f(center.x,center.y+p[4].y-p[5].y);
    sqr26[2].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    sqr26[3].position=sf::Vector2f(center.x,center.y+(p[4].y-p[5].y)/6*5);
    sqr26[3].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    sqr26[4].position=sf::Vector2f(p[5].x,p[5].y+(p[4].y-p[5].y)/6*5);
    sqr26[4].color=sf::Color(HSB_RGB(RGB_hue(255,255,0),1,1-1*slid_position));
    ...
    rhombus1[0].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,0.1));
    rhombus1[1].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,0));
    rhombus1[2].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    rhombus1[3].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,1-1*slid_position));
    rhombus1[4].color=sf::Color(HSB_RGB(RGB_hue(255,0,0),1,0.1));
