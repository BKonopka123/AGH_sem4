...
void GUIMyFrame1::Repaint()
{
	...
	scale_matrix.data[0][0] = WxSB_ScaleX->GetValue()/100.0;
    scale_matrix.data[0][1] = 0.0;
    scale_matrix.data[0][2] = 0.0;
    scale_matrix.data[0][3] = 0.0;

    scale_matrix.data[1][0] = 0.0;
	scale_matrix.data[1][1] = WxSB_ScaleY->GetValue()/100.0;
    scale_matrix.data[1][2] = 0.0;
    scale_matrix.data[1][3] = 0.0;

    scale_matrix.data[2][0] = 0.0;
    scale_matrix.data[2][1] = 0.0;
	scale_matrix.data[2][2] = WxSB_ScaleZ->GetValue()/100.0;
    scale_matrix.data[2][3] = 0.0;

    scale_matrix.data[3][0] = 0.0;
    scale_matrix.data[3][1] = 0.0;
    scale_matrix.data[3][2] = 0.0;
	...
	rotateX_matrix.data[0][0] = 1.0;
    rotateX_matrix.data[0][1] = 0.0;
    rotateX_matrix.data[0][2] = 0.0;
    rotateX_matrix.data[0][3] = 0.0;

	rotateX_matrix.data[1][0] = 0.0;
    rotateX_matrix.data[1][1] = cos(alpha);
	rotateX_matrix.data[1][2] = sin(alpha);
    rotateX_matrix.data[1][3] = 0.0;

    rotateX_matrix.data[2][0] = 0.0;
	rotateX_matrix.data[2][1] = -sin(alpha);
	rotateX_matrix.data[2][2] = cos(alpha);
    rotateX_matrix.data[2][3] = 0.0;

    rotateX_matrix.data[3][0] = 0.0;
    rotateX_matrix.data[3][1] = 0.0;
    rotateX_matrix.data[3][2] = 0.0;
    rotateX_matrix.data[3][3] = 1.0;
    
    Matrix4 rotateY_matrix;
    alpha = WxSB_RotateY->GetValue() * M_PI / 180.0;

	rotateY_matrix.data[0][0] = cos(alpha);
    rotateY_matrix.data[0][1] = 0.0;
	rotateY_matrix.data[0][2] = -sin(alpha);
    rotateY_matrix.data[0][3] = 0.0;

	rotateY_matrix.data[1][0] = 0.0;
    rotateY_matrix.data[1][1] = 1.0;
    rotateY_matrix.data[1][2] = 0.0;
    rotateY_matrix.data[1][3] = 0.0;

	rotateY_matrix.data[2][0] = sin(alpha);
    rotateY_matrix.data[2][1] = 0.0;
	rotateY_matrix.data[2][2] = cos(alpha);
    rotateY_matrix.data[2][3] = 0.0;

    rotateY_matrix.data[3][0] = 0.0;
    rotateY_matrix.data[3][1] = 0.0;
    rotateY_matrix.data[3][2] = 0.0;
    rotateY_matrix.data[3][3] = 1.0;
   
    Matrix4 rotateZ_matrix;
	alpha = WxSB_RotateZ->GetValue() * M_PI / 180.0;

	rotateZ_matrix.data[0][0] = cos(alpha);
	rotateZ_matrix.data[0][1] = sin(alpha);
    rotateZ_matrix.data[0][2] = 0.0;
    rotateZ_matrix.data[0][3] = 0.0;

	rotateZ_matrix.data[1][0] = -sin(alpha);
	rotateZ_matrix.data[1][1] = cos(alpha);
    rotateZ_matrix.data[1][2] = 0.0;
    rotateZ_matrix.data[1][3] = 0.0;

    rotateZ_matrix.data[2][0] = 0.0;
    rotateZ_matrix.data[2][1] = 0.0;
	rotateZ_matrix.data[2][2] = 1.0;
    rotateZ_matrix.data[2][3] = 0.0;

    rotateZ_matrix.data[3][0] = 0.0;
    rotateZ_matrix.data[3][1] = 0.0;
	rotateZ_matrix.data[3][2] = 0.0;
    rotateZ_matrix.data[3][3] = 1.0;

    //macierz translacji
	Matrix4 translation_matrix;

	translation_matrix.data[0][0] = 1.0;
    translation_matrix.data[0][1] = 0.0;
    translation_matrix.data[0][2] = 0.0;
	translation_matrix.data[0][3] = (WxSB_TranslationX->GetValue() - 100.0) / 50.0;

	translation_matrix.data[1][0] = 0.0;
    translation_matrix.data[1][1] = 1.0;
    translation_matrix.data[1][2] = 0.0;
	translation_matrix.data[1][3] = (WxSB_TranslationY->GetValue() - 100.0) / 50.0;

	translation_matrix.data[2][0] = 0.0;
    translation_matrix.data[2][1] = 0.0;
    translation_matrix.data[2][2] = 1.0;
	translation_matrix.data[2][3] = (WxSB_TranslationZ->GetValue() - 100.0) / 50.0;

    translation_matrix.data[3][0] = 0.0;
    translation_matrix.data[3][1] = 0.0;
    translation_matrix.data[3][2] = 0.0;
    translation_matrix.data[3][3] = 1.0;
	...
	for (Segment segment : data) 
    {
        ...
        for(int i=0; i<3; i++)
        {
            start.data[i] /= start.data[3];
            end.data[i] /= end.data[3];
        }
		...
		if ((start.GetZ() > -clip && end.GetZ() <= -clip) || (end.GetZ() > -clip && start.GetZ() <= -clip)) 
        {
			...
			a.data[0] = (b.data[0] - a.data[0]) * tmp + a.data[0];
			a.data[1] = (b.data[1] - a.data[1]) * tmp + a.data[1];
			a.data[2] = -clip;
